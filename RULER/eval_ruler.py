...
if __name__ == '__main__':
    ...
    dataset_list = ["niah_single_1", "niah_single_2", "niah_single_3", "niah_multikey_1", "niah_multikey_2",
            "niah_multiquery", "niah_multivalue", "fwe", "vt", "qa_1", "qa_2"]
    ...
    for dataset in dataset_list:
        ...
        for idx, method in enumerate(["FullKV", "SnapKV", "H2O", "quest", "SentenceKV", "infllm"]):
            try:
                args.method = method
